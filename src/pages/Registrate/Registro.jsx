      ...
      <div className="bg-gradient-to-b from-[#24274f] to-[#55F1FF] font-semibold flex justify-center items-center min-h-screen p-4 pt-34">
        <div className="bg-white p-4 rounded-xl shadow-2xl w-full max-w-[800px] relative overflow-hidden gap-6 md:gap-0 grid md:grid-cols-2">
          ...
          <div className="w-full text-center md:text-right text-black md:text-white flex flex-col justify-center z-10">
            <h3 className="text-2xl uppercase font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 from-20% to-cyan-400">
              <Typewriter words={["Regístrate"]} typeSpeed={40} cursor={false} />
              </h3>
            <p className="text-sm leading-tight ">
              Disfruta de los eventos que puedes ver en vivo, y si te animas a crear eventos.
            </p>
          </div>
        </div>
      </div>
