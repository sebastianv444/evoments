...
export default function Admin() {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/admin/eventos-pendientes`)
  ...
  const manejarAccion = async (id, accion) => {
    try {
      await axios.post(
        ...
        }/api/admin/eventos/actualizarEstadoEvento`,
        {
          id,
          accion,
        }
  ...
  return (
    <RevealOnScroll>
      <div className="pt-20 h-screen">
        <h2 className="3xl:text-2xl 4xl:text-3xl font-bold mb-10 text-center">
          Eventos Pendientes
        </h2>
        {eventos.length === 0 ? (
          ...
          <div className="px-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            {eventos.map((evento) => (
              ...
              >
                ...
                <p>
                  <strong>Localidad:</strong> {evento.venue.localidad}
                </p>
                <p>
                  <strong>Nombre de la zona:</strong> {evento.venue.nombre}
                </p>
                <p>
                  <strong className="text-red-600">Ubicación:</strong>{" "}
                  {evento.venue.direccion}
                </p>
                <p>
                  <strong>Fecha:</strong>{" "}
